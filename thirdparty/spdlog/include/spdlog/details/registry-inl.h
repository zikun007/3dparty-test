...
// support for the default stdout logger (trimmed: uses plain stdout sink)
...
#ifndef SPDLOG_DISABLE_DEFAULT_LOGGER
    // create default logger (stdout_sink_mt in this trimmed build)
    auto default_sink = std::make_shared<sinks::stdout_sink_mt>();

    const char *default_logger_name = "";
    default_logger_ = std::make_shared<logger>(default_logger_name, std::move(default_sink));
